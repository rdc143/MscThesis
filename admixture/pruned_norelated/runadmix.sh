...
plink --allow-extra-chr --bfile $inputpath --keep keep_list.txt --maf 0.01 --geno 0.1 --make-bed --out plink_pre
...
# ld prune
plink --allow-extra-chr --bfile plink_pre --indep-pairwise 50 10 0.5
