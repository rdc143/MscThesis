...
inputpath=$"/maps/projects/seqafrica/scratch/rdc143/trag_analyses/plink/BosTau9_tragmain2_sites_variable_noindels_8dp_5missing_nomultipoly_norelated2"
threads=50
admixit=100 # max no. of runs of admixture for each K

species="Tory_nofarms"
clusters=6
