...
inputpath="/home/rdc143/trag_analyses/bed/BosTau9_tragmain2_sites_variable_noindels_8dp_fixedout"
...
do
    ...
    # only use samples previously designated as related in prelim qc
    #comm -12 <(sort /home/rdc143/trag_analyses/bed/keep_unrelated.txt) <(sort keep_list.txt) > keep_list.txt.tmp
